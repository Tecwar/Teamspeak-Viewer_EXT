...
class TeamSpeak3_Viewer_Html implements TeamSpeak3_Viewer_Interface
{
   ...
   * @var string
   */
  protected $pattern = "<table id='%0' class='%1' summary='%2'><tr class='%3'><td class='%4'>%5</td><td class='%6' title='%7'>%8 <span class='top'> %9</span></td><td class='%10'>%11%12</td></tr></table>\n";
  ...
  protected function getImage($name, $text = "", $class = null, $iconpath = TRUE, $flagpath = FALSE)
  {
    ...
    return "<img src='" . $src . $name . "' title='" . $text . "' alt='' align='bottom' />";
  }
}
